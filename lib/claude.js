...
// Models sometimes wrap JSON in markdown fences, or add stray content
// before/after it despite instructions. Strip fences, then fall back to
...
function parseJson(text) {
  ...
  try {
    ...
    if (!extracted) throw new Error(`Could not parse JSON from: ${cleaned.slice(0, 200)}`);
