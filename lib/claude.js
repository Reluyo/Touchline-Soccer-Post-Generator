...
// before/after it, or leave a trailing comma before a closing bracket
// despite instructions. Strip fences and trailing commas, then fall
// back to extracting the first balanced JSON value rather than failing
// the run. If it's still invalid, throw the parser's own reason plus a
// snippet of what it choked on -- a bare native error here otherwise
// gives no clue which of several JSON-producing calls (rank, write,
// chat) failed or why.
